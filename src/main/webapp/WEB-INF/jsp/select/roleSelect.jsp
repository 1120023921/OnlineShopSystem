...
<div class="easyui-layout" data-options="fit:true">
	<div region="west" style="width: 45%" title="已选角色" collapsible="false">
		<table id="sdg" class="easyui-datagrid"
			style="width: 100%; height: 370px;"
			url="${pageContext.request.contextPath}/role/getRolesByUserId.do?userId=${userId}"
			pagination="true" rownumbers="true" fitColumns="true"
			buttons="#dg-buttons">
			<thead>
				<tr>
					<th field="roid" width="50">编码</th>
	...
	<div region="east" style="width: 45%" title="可选角色" collapsible="false">
		...
		<div id="usdgtb">
			<div id="tb" style="padding: 3px">
				<select id="key"><option value="roid">编码</option>
